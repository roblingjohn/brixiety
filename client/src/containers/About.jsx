    ...
    return (
      <div className="container">
        ...
        <p className="pageText">
          ...
          people can relate to me as well. However, I can't draw to save my
          life, so I figured I could use the thousands of dollars worth of LEGOs
          I have acquired since my childhood to convey my ideas.
        </p>
      </div>
    );
  }
